...
filename = sprintf('ber_mc_zf_clip_%s_%d_%d.mat', precoder_type, M, K);
save(fullfile(simulation, filename), 'M', 'K', 'SNR', 'BER', 'N_AMP', 'N_A0', 'A0', 'precoder_type', 'amplifiers_type');